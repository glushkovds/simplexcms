...
-- Дата скрипта: 07.01.2019 23:40:55
-- Версия сервера: 5.5.12
-- Версия клиента: 4.1
--
...
--
-- Удалить таблицу `cron`
--
DROP TABLE IF EXISTS cron;

--
-- Удалить таблицу `cron_log`
--
...
--
-- Удалить таблицу `mail_log`
--
DROP TABLE IF EXISTS mail_log;

--
-- Удалить таблицу `plug_cache`
--
...
--
-- Удалить таблицу `slider`
--
DROP TABLE IF EXISTS slider;

--
-- Удалить таблицу `struct_table_right`
--
DROP TABLE IF EXISTS struct_table_right;

--
-- Удалить таблицу `component_param`
--
...
--
-- Удалить таблицу `component`
--
DROP TABLE IF EXISTS component;

--
-- Удалить таблицу `module_param`
--
DROP TABLE IF EXISTS module_param;

--
-- Удалить таблицу `struct_data`
--
DROP TABLE IF EXISTS struct_data;

--
-- Удалить таблицу `struct_field_param`
--
DROP TABLE IF EXISTS struct_field_param;

--
-- Удалить таблицу `struct_param`
--
DROP TABLE IF EXISTS struct_param;

--
-- Удалить таблицу `struct_field`
--
DROP TABLE IF EXISTS struct_field;

--
-- Удалить таблицу `module_item`
--
DROP TABLE IF EXISTS module_item;

--
-- Удалить таблицу `module`
--
DROP TABLE IF EXISTS module;

--
-- Удалить таблицу `struct_table`
--
DROP TABLE IF EXISTS struct_table;

--
-- Удалить таблицу `admin_menu`
--
DROP TABLE IF EXISTS admin_menu;

--
-- Удалить таблицу `admin_widget`
--
...
--
-- Удалить таблицу `user_role_priv`
--
...
--
-- Удалить таблицу `user_priv`
--
DROP TABLE IF EXISTS user_priv;

--
-- Создать таблицу `user_priv`
--
...
ADD CONSTRAINT FK_user_role_user_priv_priv_id FOREIGN KEY (priv_id)
REFERENCES user_priv (priv_id);

--
-- Создать таблицу `user_role_priv`
--
...
ADD CONSTRAINT FK_user_role_priv_user_priv_priv_id FOREIGN KEY (priv_id)
REFERENCES user_priv (priv_id);
...
--
ALTER TABLE user_role_priv
ADD CONSTRAINT FK_user_role_priv_user_role_role_id FOREIGN KEY (role_id)
...
--
-- Создать индекс `UK_user_login` для объекта типа таблица `user`
--
ALTER TABLE user
ADD UNIQUE INDEX UK_user_login (login);

--
-- Создать внешний ключ
--
ALTER TABLE user
ADD CONSTRAINT FK_user_user_role_role_id FOREIGN KEY (role_id)
REFERENCES user_role (role_id);

--
-- Создать таблицу `admin_widget`
--
...
ADD CONSTRAINT FK_admin_widget_user_priv_priv_id FOREIGN KEY (priv_id)
REFERENCES user_priv (priv_id) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Создать таблицу `admin_menu`
--
...
ADD CONSTRAINT FK_admin_menu_admin_menu_menu_id FOREIGN KEY (menu_pid)
REFERENCES admin_menu (menu_id);

--
-- Создать внешний ключ
--
ALTER TABLE admin_menu
ADD CONSTRAINT FK_admin_menu_user_priv_priv_id FOREIGN KEY (priv_id)
REFERENCES user_priv (priv_id);

--
-- Создать таблицу `struct_table`
--
CREATE TABLE struct_table (
  table_id int(11) NOT NULL AUTO_INCREMENT,
  name varchar(50) NOT NULL,
  order_by varchar(255) DEFAULT NULL,
  order_desc int(1) DEFAULT NULL,
...
--
-- Создать индекс `UK_struct_table_name` для объекта типа таблица `struct_table`
--
ALTER TABLE struct_table
ADD UNIQUE INDEX UK_struct_table_name (name);

--
-- Создать таблицу `module`
--
CREATE TABLE module (
  ...
  postexec int(1) NOT NULL DEFAULT 0 COMMENT 'Выполнять после контента',
...
--
-- Создать индекс `FK_module_item_position_position_id` для объекта типа таблица `module_item`
--
ALTER TABLE module_item
ADD INDEX FK_module_item_position_position_id (posname);

--
-- Создать внешний ключ
--
ALTER TABLE module_item
ADD CONSTRAINT FK_module_item_module_module_id FOREIGN KEY (module_id)
REFERENCES module (module_id);

--
-- Создать таблицу `struct_field`
--
...
ADD CONSTRAINT FK_struct_param_struct_field_field_id FOREIGN KEY (field_id)
REFERENCES struct_field (field_id);

--
-- Создать внешний ключ
--
ALTER TABLE struct_param
ADD CONSTRAINT FK_struct_param_struct_param_param_id FOREIGN KEY (param_pid)
REFERENCES struct_param (param_id);

--
-- Создать внешний ключ
--
ALTER TABLE struct_param
ADD CONSTRAINT FK_struct_param_struct_table_table_id FOREIGN KEY (table_id)
REFERENCES struct_table (table_id);

--
-- Создать таблицу `struct_field_param`
--
...
ADD CONSTRAINT FK_struct_field_param_struct_field_field_id FOREIGN KEY (field_id)
REFERENCES struct_field (field_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать внешний ключ
--
ALTER TABLE struct_field_param
ADD CONSTRAINT FK_struct_field_param_struct_field_field_id2 FOREIGN KEY (type_id)
REFERENCES struct_field (field_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать таблицу `struct_data`
--
...
--
-- Создать индекс `UK_struct_data` для объекта типа таблица `struct_data`
--
ALTER TABLE struct_data
ADD UNIQUE INDEX UK_struct_data (table_id, name);

--
-- Создать внешний ключ
--
ALTER TABLE struct_data
ADD CONSTRAINT FK_struct_data_struct_field_field_id FOREIGN KEY (field_id)
REFERENCES struct_field (field_id);
...
--
ALTER TABLE struct_data
ADD CONSTRAINT FK_struct_data_struct_table_table_id FOREIGN KEY (table_id)
REFERENCES struct_table (table_id);

--
-- Создать таблицу `module_param`
--
...
ADD CONSTRAINT FK_module_param_module_module_id FOREIGN KEY (module_id)
...
--
ALTER TABLE module_param
ADD CONSTRAINT FK_module_param_module_param_mp_id FOREIGN KEY (param_pid)
REFERENCES module_param (mp_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать внешний ключ
--
ALTER TABLE module_param
ADD CONSTRAINT FK_module_param_struct_field_field_id FOREIGN KEY (field_id)
REFERENCES struct_field (field_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать таблицу `component`
--
...
--
ALTER TABLE menu
ADD CONSTRAINT FK_menu_component_component_id FOREIGN KEY (component_id)
REFERENCES component (component_id) ON DELETE SET NULL;

--
-- Создать внешний ключ
--
ALTER TABLE menu
ADD CONSTRAINT FK_menu_menu_menu_id FOREIGN KEY (menu_pid)
REFERENCES menu (menu_id);

--
-- Создать таблицу `component_param`
--
...
ADD CONSTRAINT FK_component_param_component_component_id FOREIGN KEY (component_id)
REFERENCES component (component_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать внешний ключ
--
ALTER TABLE component_param
ADD CONSTRAINT FK_component_param_component_param_mp_id FOREIGN KEY (param_pid)
REFERENCES component_param (cp_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать внешний ключ
--
ALTER TABLE component_param
ADD CONSTRAINT FK_component_param_struct_field_field_id FOREIGN KEY (field_id)
REFERENCES struct_field (field_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать таблицу `struct_table_right`
--
...
CHARACTER SET utf8,
COLLATE utf8_general_ci,
COMMENT = 'Права пользователей на таблицу';

--
-- Создать таблицу `slider`
--
CREATE TABLE slider (
...
--
ALTER TABLE seo
ADD CONSTRAINT FK_seo_seo_seo_id FOREIGN KEY (seo_pid)
REFERENCES seo (seo_id) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Создать таблицу `plug_cache`
--
CREATE TABLE plug_cache (
  ...
  PRIMARY KEY USING BTREE (cache_key)
)
ENGINE = MEMORY,
AVG_ROW_LENGTH = 63776,
CHARACTER SET utf8,
COLLATE utf8_general_ci;

--
-- Создать таблицу `mail_log`
--
CREATE TABLE mail_log (
  log_id int(11) NOT NULL AUTO_INCREMENT,
  success int(1) NOT NULL COMMENT '1 - отправлено, 0 - не отправлено, ошибки при отправке',
...
CHARACTER SET utf8,
COLLATE utf8_general_ci,
COMMENT = 'Журнал входов в админку. По умолчанию отключен. Включать в AdminPlugLog';

--
-- Создать таблицу `cron_log`
--
...
-- 
-- Вывод данных для таблицы user_priv
--
INSERT INTO user_priv VALUES
...
-- 
-- Вывод данных для таблицы struct_table
--
INSERT INTO struct_table VALUES
(1, 'struct_table', NULL, NULL, NULL, NULL, NULL),
(2, 'struct_field', NULL, NULL, NULL, NULL, NULL),
(3, 'struct_data', 'npp', NULL, NULL, NULL, NULL),
(4, 'struct_param', NULL, NULL, NULL, NULL, NULL),
(5, 'admin_menu', 'npp', NULL, NULL, NULL, NULL),
(6, 'user_priv', NULL, NULL, NULL, NULL, NULL),
(7, 'user_role', NULL, NULL, NULL, NULL, NULL),
(8, 'user', NULL, NULL, NULL, NULL, NULL),
(9, 'user_role_priv', NULL, NULL, NULL, NULL, NULL),
(10, 'menu', 'npp', NULL, NULL, NULL, NULL),
(11, 'component', NULL, NULL, NULL, NULL, NULL),
(12, 'content', NULL, NULL, NULL, NULL, NULL),
(22, 'settings', 'npp', NULL, NULL, NULL, NULL),
(23, 'struct_field_param', NULL, NULL, NULL, NULL, NULL),
(24, 'module', NULL, NULL, NULL, NULL, NULL),
(25, 'module_item', 'npp', NULL, NULL, NULL, NULL),
(26, 'seo', NULL, NULL, NULL, NULL, NULL),
(28, 'module_param', 'npp', NULL, NULL, NULL, NULL),
(29, 'component_param', 'npp', NULL, NULL, NULL, NULL),
(30, 'slider', 'npp', NULL, NULL, NULL, NULL),
(31, 'callback', 'datetime', 1, NULL, NULL, NULL),
(32, 'log', 'log_id', 1, NULL, NULL, NULL),
(33, 'cron', NULL, NULL, 1, 1, 1);

-- 
-- Вывод данных для таблицы module
--
INSERT INTO module VALUES
(1, 'ModMenu', 'Меню', 'site', 0),
(2, 'ModContent', 'Список материалов', 'site', 0),
(3, 'ModBreadcrumbs', 'Хлебные крошки', 'site', 1),
(4, 'ModBlock', 'Текстовый блок', 'site', 0),
(7, 'AdminModBreadCrumbs', 'Admin. Хлебные крошки', 'admin', 0),
(8, 'AdminModMenu', 'Admin. Меню', 'admin', 0),
(9, 'ModSlider', 'Слайдер', 'site', 0),
(10, 'ModCallback', 'Обратный звонок', 'site', 0),
(11, 'AdminModAccount', 'Admin. Аккаунт', 'admin', 0),
(12, 'AdminModInstall', 'Admin. Репозиторий', 'admin', 0),
(13, 'ModCode', 'Код', 'site', 0);

-- 
-- Вывод данных для таблицы struct_field
--
INSERT INTO struct_field VALUES
(1, 'Строка', 'SFFString'),
(2, 'Целое число', 'SFFInt'),
(3, 'Булевая переменная', 'SFFBool'),
(4, 'Алиас', 'SFFAlias'),
(5, 'Url-путь', 'SFFPath'),
(6, 'Пароль', 'SFFPassword'),
(7, 'Дата', 'SFFDate'),
(8, 'Дата и время', 'SFFDateTime'),
(9, 'Текст', 'SFFText'),
(10, 'Файл', 'SFFFile'),
(11, 'Изображение', 'SFFImage'),
(14, 'Варианты', 'SFFEnum'),
(15, '№ п/п', 'SFFNPP'),
(16, 'Виртуальное поле', 'SFFVirtual'),
(17, 'Время', 'SFFTime'),
(18, 'Дробное число', 'SFFDouble'),
(19, 'Связь многие ко многим', 'SFFMultiKey'),
(20, 'Пароль видимый', 'SFFPasswordVisible');

-- 
-- Вывод данных для таблицы component
--
INSERT INTO component VALUES
(1, 'ComContent', 'Материалы', 'a:2:{s:6:"аег";s:1:"q";s:6:"groupp";a:1:{s:4:"jopa";s:1:"2";}}');

-- 
-- Вывод данных для таблицы user_role_priv
--
INSERT INTO user_role_priv VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
(1, 1, 1, 'dev', 'b8700830eb7bdd7a4823df4827f97c28', 'fb1a392b083e3121edd7c9046be62baa', '93d38359fbacdbd3b1986ad43090aef0', '', '', NULL),
(2, 2, 1, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'e1c3403a66d1269c4e3edbae11c11f03', '', NULL, '', NULL);

-- 
-- Вывод данных для таблицы struct_table_right
--
-- Таблица simplex.struct_table_right не содержит данных

-- 
-- Вывод данных для таблицы struct_param
--
INSERT INTO struct_param VALUES
(1, NULL, 3, NULL, 'right', 'main', 'Параметры', '', NULL),
(2, 1, 3, 3, '', 'pk', 'Первичный ключ', '', NULL),
(3, 1, 3, 3, '', 'e2n', 'Преобразовать к NULL', '', NULL),
(4, 1, 3, 3, '', 'hidden', 'Скрытый', '', NULL),
(5, 1, 3, 2, '', 'width', 'Ширина столбца', '', NULL),
(6, 1, 3, 1, '', 'defaultValue', 'Значение по умолчанию', '', NULL),
(7, 1, 3, 3, '', 'required', 'Обязательно для заполнения', '', NULL),
(8, 1, 3, 3, '', 'filter', 'Добавить в фильтр', '', NULL),
(10, NULL, 12, NULL, 'right', 'content_main', 'Вывод данных', '', NULL),
(11, 10, 12, 1, '', 'tpl', 'Шаблон вывода', 'mod_list.tpl', NULL),
(12, 10, 12, 2, '', 'cnt_limit', 'Количество', '3', NULL),
(13, NULL, 12, NULL, 'right', 'content_view', 'Внешний вид', '', NULL),
(14, 13, 12, 3, '', 'date', 'Дата', '', NULL),
(15, 13, 12, 3, '', 'short', 'Анонс', '0', NULL),
(16, 13, 12, 3, '', 'more', 'Кнопка далее', '0', NULL),
(17, 13, 12, 1, '', 'more_text', 'Текст на кнопке далее', 'Читать далее', NULL),
(18, 1, 3, 1, '', 'onchange', 'on change', '', NULL),
(19, NULL, 4, NULL, 'right', 'main', 'Параметры', '', NULL),
(20, 19, 4, 1, '', 'defaultValue', 'Значение по умолчанию', '', NULL),
(21, NULL, 28, NULL, 'right', 'module_param_main', 'Параметры', '', NULL),
(22, 21, 28, 1, '', 'default_value', 'Значение по умолчанию', '', NULL),
(23, NULL, 25, NULL, 'right', 'module_item_main', 'Параметры', '', NULL),
(25, NULL, 25, 3, 'right', 'is_title', 'Показывать заголовок', '1', NULL),
(26, NULL, 25, 3, 'right', 'is_wrap', 'Выводить обертку', '1', NULL),
(27, 10, 12, 3, '', 'hide_title', 'Не показывать заголовок', '0', 'a:1:{s:4:"main";a:1:{s:12:"defaultValue";s:1:"0";}}'),
(28, 1, 3, 3, '', 'readonly', 'Только чтение', '0', 'a:1:{s:4:"main";a:1:{s:12:"defaultValue";s:0:"";}}'),
(29, 1, 3, 1, '', 'style_cell', 'CSS стили ячейки', '', 'a:1:{s:4:"main";a:1:{s:12:"defaultValue";s:0:"";}}'),
(30, NULL, 25, 1, 'right', 'cssclass', 'CSS Класс', '', 'a:1:{s:4:"main";a:1:{s:12:"defaultValue";s:0:"";}}');

-- 
-- Вывод данных для таблицы struct_field_param
--
INSERT INTO struct_field_param VALUES
...
-- 
-- Вывод данных для таблицы struct_data
--
INSERT INTO struct_data VALUES
(1, 0, 1, 2, 'table_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(2, 0, 1, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(3, 0, 2, 2, 'field_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(4, 0, 2, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(6, 0, 3, 2, 'id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(7, 1, 3, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"80";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(8, 2, 3, 2, 'table_id', 'Таблица', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:26:"struct_table.table_id.name";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:12:"struct_table";s:6:"fk_key";s:8:"table_id";s:8:"fk_label";s:4:"name";s:9:"fk_is_pid";s:1:"0";}}'),
(9, 3, 3, 2, 'field_id', 'Тип данных', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"1";s:2:"fk";s:26:"struct_field.field_id.name";s:8:"onchange";s:19:"onChangeField(this)";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:12:"struct_field";s:6:"fk_key";s:8:"field_id";s:8:"fk_label";s:4:"name";s:9:"fk_is_pid";s:1:"0";}}'),
(10, 4, 3, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(11, 5, 3, 1, 'label', 'Ярлык', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(12, 0, 4, 2, 'param_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(16, 4, 4, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(22, 1, 5, 2, 'menu_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(24, 3, 5, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"80";s:12:"defaultValue";s:1:"0";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(26, 5, 5, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(27, 6, 5, 1, 'link', 'Ссылка', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(28, 7, 5, 1, 'model', 'Модель', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(29, 1, 6, 2, 'priv_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(32, 4, 6, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"200";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(34, 1, 7, 1, 'role_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(36, 3, 7, 3, 'active', 'Активно', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"85";s:12:"defaultValue";s:1:"1";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(37, 4, 7, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"80";s:12:"defaultValue";s:1:"0";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(38, 6, 7, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(39, 1, 8, 2, 'user_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";}}'),
(40, 3, 8, 2, 'role_id', 'Роль', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"140";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"1";s:2:"fk";s:22:"user_role.role_id.name";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:9:"user_role";s:6:"fk_key";s:7:"role_id";s:8:"fk_label";s:4:"name";s:9:"fk_is_pid";s:1:"0";}}'),
(41, 2, 8, 3, 'active', 'Активно', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"85";s:12:"defaultValue";s:1:"0";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(42, 4, 8, 1, 'login', 'Логин', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(48, 1, 10, 2, 'menu_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(50, 5, 10, 2, 'component_id', 'Компонент', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:1:"0";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:27:"component.component_id.name";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:9:"component";s:6:"fk_key";s:12:"component_id";s:8:"fk_label";s:4:"name";s:9:"fk_is_pid";s:1:"0";}}'),
(51, 1, 10, 3, 'active', 'Активно', '', '', 'a:1:{s:4:"main";a:10:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"85";s:12:"defaultValue";s:1:"1";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";}}'),
(52, 2, 10, 3, 'hidden', 'Скрыть', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"80";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(53, 3, 10, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:10:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"80";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";}}'),
(54, 7, 10, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(55, 8, 10, 1, 'link', 'Ссылка', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(59, 1, 12, 2, 'content_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(60, 3, 12, 2, 'pid', 'Родитель', '', '', 'a:1:{s:4:"main";a:13:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:3:"180";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:7:"content";s:6:"fk_key";s:10:"content_id";s:8:"fk_label";s:5:"title";s:9:"fk_is_pid";s:1:"1";}}'),
(61, 2, 12, 3, 'active', 'Активно', '', '', 'a:1:{s:4:"main";a:10:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"85";s:12:"defaultValue";s:1:"1";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";}}'),
...
(63, 5, 12, 1, 'title', 'Заголовок', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(64, 6, 12, 4, 'alias', 'Алиас', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"180";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:6:"source";s:5:"title";}}'),
...
(70, 8, 5, 1, 'icon', 'Иконка', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"100";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(71, 0, 22, 2, 'setting_id', 'ID', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"50";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"0";s:8:"fk_table";s:0:"";s:6:"fk_key";s:0:"";s:8:"fk_label";s:0:"";s:9:"fk_is_pid";s:1:"0";}}'),
(72, 0, 22, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"90";s:12:"defaultValue";s:1:"0";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
(73, 0, 22, 1, 'name', 'Наименование', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(74, 0, 22, 1, 'alias', 'Алиас', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"200";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(75, 0, 22, 9, 'value', 'Значение', '', '', 'a:1:{s:4:"main";a:10:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:11:"editor_mini";s:1:"0";s:11:"editor_full";s:1:"0";}}'),
...
(78, 0, 23, 2, 'fp_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"50";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(80, 2, 23, 1, 'name', 'Наименование', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";}}'),
...
(84, 0, 24, 2, 'module_id', 'ID', '', '', 'a:1:{s:4:"main";a:13:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"50";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"0";s:8:"fk_table";s:0:"";s:6:"fk_key";s:0:"";s:8:"fk_label";s:0:"";s:9:"fk_is_pid";s:1:"0";}}'),
...
(86, 0, 24, 1, 'name', 'Наименование', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
...
(93, -2, 25, 2, 'item_id', 'ID', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"1";s:5:"width";s:2:"50";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"0";s:8:"fk_table";s:0:"";s:6:"fk_key";s:0:"";s:8:"fk_label";s:0:"";s:9:"fk_is_pid";s:1:"0";}}'),
...
(95, 3, 25, 2, 'menu_id', 'Меню', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:3:"200";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"1";s:8:"fk_table";s:4:"menu";s:6:"fk_key";s:7:"menu_id";s:8:"fk_label";s:4:"name";s:9:"fk_is_pid";s:1:"0";}}'),
(96, 0, 25, 1, 'posname', 'Позиция', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"150";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(97, -2, 25, 3, 'active', 'Активно', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"90";s:12:"defaultValue";s:1:"1";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
(98, -1, 25, 15, 'npp', '№ п/п', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:2:"90";s:12:"defaultValue";s:1:"0";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";s:5:"is_fk";s:1:"0";s:8:"fk_table";s:0:"";s:6:"fk_key";s:0:"";s:8:"fk_label";s:0:"";s:9:"fk_is_pid";s:1:"0";}}'),
(99, 0, 25, 1, 'name', 'Наименование', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
...
(225, 1, 26, 2, 'seo_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:5:"is_fk";s:0:"";}}'),
...
(227, 3, 26, 1, 'link', 'Ссылка', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"1";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(228, 4, 26, 1, 'title', 'Заголовок', '', '', 'a:1:{s:4:"main";a:10:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";}}'),
...
(255, 1, 28, 2, 'mp_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:5:"is_fk";s:0:"";}}'),
...
(259, 5, 28, 1, 'name', 'Название', '', '', 'a:1:{s:4:"main";a:9:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"1";s:2:"fk";s:0:"";s:8:"onchange";s:0:"";}}'),
...
(291, 1, 31, 2, 'callback_id', 'ID', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"1";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"1";s:5:"width";s:2:"60";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:5:"is_fk";s:0:"";}}'),
(292, 2, 31, 8, 'datetime', 'Время', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"150";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(293, 4, 31, 1, 'name', 'ФИО', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(294, 3, 31, 1, 'phone', 'Телефон', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"200";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
...
(309, 8, 8, 1, 'email', 'Email', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:3:"140";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(310, 9, 8, 1, 'name', 'ФИО', '', '', 'a:1:{s:4:"main";a:8:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"0";s:6:"hidden";s:1:"0";s:5:"width";s:3:"150";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";}}'),
(311, 5, 31, 9, 'comments', 'Комментарий', '', '', 'a:1:{s:4:"main";a:12:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:1:"1";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";s:11:"editor_mini";s:1:"0";s:11:"editor_full";s:1:"0";}}'),
...
(313, 11, 12, 11, 'photo', 'Фото', '', '', 'a:1:{s:4:"main";a:14:{s:2:"pk";s:1:"0";s:3:"e2n";s:1:"1";s:6:"hidden";s:1:"0";s:5:"width";s:3:"130";s:12:"defaultValue";s:0:"";s:8:"required";s:1:"0";s:6:"filter";s:1:"0";s:8:"onchange";s:0:"";s:8:"readonly";s:1:"0";s:10:"style_cell";s:0:"";s:4:"path";s:7:"content";s:5:"small";s:7:"200x150";s:6:"medium";s:0:"";s:5:"large";s:7:"800x600";}}');

-- 
-- Вывод данных для таблицы slider
--
-- Таблица simplex.slider не содержит данных

-- 
-- Вывод данных для таблицы settings
--
INSERT INTO settings VALUES
(1, 0, 'Название сайта', 'site_name', 'Simplex Framework'),
(2, 99, 'Ошибка 404', 'error404', '<h1>Ошибка 404</h1>\r\n<p>Запрашиваемая страница не найдена.</p>'),
(6, 0, 'Email', 'email', 'info@site.ru'),
(7, 0, 'Телефон', 'phone', '<span>8 800</span> 100-00-00'),
(8, 1, 'Версия статики сайта', 'static_version', '0'),
(9, 11, 'Часы работы', 'workhours', 'ПН-ВС — с 09:00 до 18:00'),
(11, 111, 'SMTP отправитель', 'sender', 'email:pass'),
(12, 1, 'Кэш JS', 'static_cache_js', '/theme/default/js/default.js'),
(13, 1, 'Кэш CSS', 'static_cache_css', '/theme/default/css/default.css\r\n'),
(14, 1, 'Кэш', 'static_cache', '0'),
(15, 1, 'Домен для статики', 'static_domain', ''),
(16, 1, 'Статика. Загружать с разных поддоменов', 'static_domain_sub', '0'),
(17, 200, 'Запрет отправки писем', 'send_deny_email', '');

-- 
-- Вывод данных для таблицы seo
--
INSERT INTO seo VALUES
(1, NULL, '/', '', '', '', NULL);

-- 
-- Вывод данных для таблицы plug_cache
--
-- Таблица simplex.plug_cache не содержит данных

-- 
-- Вывод данных для таблицы module_param
--
INSERT INTO module_param VALUES
...
(18, 10, NULL, 'left', 1, 'subject', 'Заголовок письма', 0, '', 'a:1:{s:17:"module_param_main";a:1:{s:13:"default_value";s:29:"Обратный звонок";}}'),
(19, 10, NULL, 'left', 1, 'email', 'Email', 1, '', 'a:1:{s:17:"module_param_main";a:1:{s:13:"default_value";s:0:"";}}'),
(20, 10, NULL, 'left', 9, 'message', 'Текст письма', 0, '', 'a:2:{s:17:"module_param_main";a:1:{s:13:"default_value";s:120:"Поступила заявка на обратный звонок с сайта: Имя: {name} Телефон: {phone}";}s:4:"main";a:2:{s:11:"editor_mini";s:1:"1";s:11:"editor_full";s:1:"0";}}'),
...
-- 
-- Вывод данных для таблицы module_item
--
INSERT INTO module_item VALUES
(1, 1, NULL, 'mainmenu', 1, 0, 'Меню главное', 'a:4:{s:8:"is_title";s:1:"0";s:9:"max_level";s:1:"0";s:8:"start_id";s:4:"NULL";s:8:"is_child";s:1:"0";}'),
...
(2, NULL, NULL, 1, 0, 2, 'О компании', '/company/'),
(3, NULL, NULL, 1, 0, 3, 'Продукция', '/catalog/'),
(4, NULL, NULL, 1, 0, 4, 'Услуги', '/services/'),
(7, NULL, NULL, 1, 0, 7, 'Контакты', '/contacts/');

-- 
-- Вывод данных для таблицы mail_log
--
-- Таблица simplex.mail_log не содержит данных

-- 
-- Вывод данных для таблицы log
--
INSERT INTO log VALUES
(1, '2017-10-04 11:31:28', 'login_success', '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:50.0) Gecko/20100101 Firefox/50.0', 'Логин: dev');

-- 
-- Вывод данных для таблицы cron_log
--
-- Таблица simplex.cron_log не содержит данных

-- 
-- Вывод данных для таблицы cron
--
-- Таблица simplex.cron не содержит данных

-- 
-- Вывод данных для таблицы content
--
INSERT INTO content VALUES
(1, NULL, 1, '2020-12-20', 'Спецтехника в Перми', '/', '/', '', '<p>Управляющая компания ООО &laquo;Актив Финанс групп&raquo; - это развивающееся предприятие, которое имеет квалифицированный штат сотрудников с длительным опытом работы в области жилищно-коммунального хозяйства, собственные производственные мощности. Помимо юридического отдела, паспортного отдела, бухгалтерии, наша организация имеет производственный отдел с квалифицированным техническим персоналом, куда входят слесари-сантехники, электрики, сварщики. В компании организована круглосуточная аварийно-диспетчерская служба.</p>', 'a:2:{s:12:"content_main";a:3:{s:3:"tpl";s:0:"";s:9:"cnt_limit";s:1:"0";s:10:"hide_title";s:1:"0";}s:12:"content_view";a:4:{s:4:"date";s:1:"0";s:5:"short";s:1:"0";s:4:"more";s:1:"0";s:9:"more_text";s:0:"";}}', NULL, NULL),
(2, NULL, 1, '2012-02-01', 'О компании', 'company', '/company/', '', '<p style="text-align: justify;"><span style="text-align: justify;"><em>В соответствии с Постановлением Правительства РФ № 731 от 23.09.2010 г. "Об утверждении стандарта раскрытия информации организациями, осуществляющими деятельность в сфере управления многоквартирными домами"</em> &nbsp;</span></p>\r\n<p style="text-align: justify;"><strong style="text-align: justify;">управляющая организация обязана раскрывать следующую информацию:</strong></p>\r\n<p style="text-align: justify;">&nbsp;а) общая информация об управляющей организации;&nbsp;</p>\r\n<p>б) основные показатели финансово-хозяйственной деятельности управляющей организации (в части исполнения такой управляющей организацией договоров управления);</p>\r\n<p>в) сведения о выполняемых работах (оказываемых услугах) по содержанию и ремонту общего имущества в многоквартирном доме;</p>\r\n<p>г) порядок и условия оказания услуг по содержанию и ремонту общего имущества в многоквартирном доме;</p>\r\n<p>д) сведения о стоимости работ (услуг) по содержанию и ремонту общего имущества в многоквартирном доме;</p>\r\n<p>е) сведения о ценах (тарифах) на коммунальные ресурсы.</p>', 'a:2:{s:12:"content_main";a:2:{s:3:"tpl";s:0:"";s:9:"cnt_limit";s:1:"0";}s:12:"content_view";a:4:{s:4:"date";s:1:"0";s:5:"short";s:1:"0";s:4:"more";s:1:"0";s:9:"more_text";s:0:"";}}', NULL, NULL),
(3, NULL, 1, '2012-12-20', 'Каталог продукции', 'catalog', '/catalog/', 'Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста. Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста.', '<p>Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста. Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста.</p>\r\n<p>Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста. Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста.</p>\r\n<p>Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста. Небольшое описание каталога продукции, если оно вообще требуется, можно оставить страницу и без текста.</p>', 'a:2:{s:10:"hide_title";s:1:"0";s:13:"hide_children";s:1:"0";}', NULL, NULL),
(4, NULL, 1, '2012-12-20', 'Услуги', 'services', '/services/', '', '<table border="1">\r\n<tbody>\r\n<tr>\r\n<td style="text-align: center; background-color: #dddddd;" colspan="2">Экстренные телефоны</td>\r\n</tr>\r\n<tr>\r\n<td>Пожарная охрана</td>\r\n<td>01</td>\r\n</tr>\r\n<tr>\r\n<td>Милиция</td>\r\n<td>02</td>\r\n</tr>\r\n<tr>\r\n<td>Скорая медицинская помощь</td>\r\n<td>03</td>\r\n</tr>\r\n<tr>\r\n<td>Аварийная газовая служба</td>\r\n<td>04; 282-52-10</td>\r\n</tr>\r\n<tr>\r\n<td>Служба спасения</td>\r\n<td>112; 268-02-00</td>\r\n</tr>\r\n<tr>\r\n<td>Скорая ветеринарная медицинская помощь</td>\r\n<td>210-15-60; 212-68-37</td>\r\n</tr>\r\n<tr>\r\n<td>Медицина катастроф (при крупных ДТП, пожарах)</td>\r\n<td>241-44-44; 212-33-99; 281-01-73</td>\r\n</tr>\r\n<tr>\r\n<td>Психологическая служба</td>\r\n<td>066</td>\r\n</tr>\r\n<tr>\r\n<td>Детский телефон доверия</td>\r\n<td>8-800-3000-122</td>\r\n</tr>\r\n<tr>\r\n<td>Скорая психиатрическая помощь</td>\r\n<td>263-07-03</td>\r\n</tr>\r\n<tr>\r\n<td style="text-align: center; background-color: #dddddd;" colspan="2">Правоохранительные органы</td>\r\n</tr>\r\n<tr>\r\n<td>ГУВД России по Пермскому краю (телефон доверия)</td>\r\n<td>246-88-99</td>\r\n</tr>\r\n<tr>\r\n<td>Бюро несчастных случаев ГУВД ПК (пропажа людей)</td>\r\n<td>244-37-64</td>\r\n</tr>\r\n<tr>\r\n<td>Дежурная часть ГУВД по Пермскому краю</td>\r\n<td>246-77-00</td>\r\n</tr>\r\n<tr>\r\n<td>Дежурная часть ГИБДД ГУВД по Пермскому краю</td>\r\n<td>282-06-38; 282-18-21</td>\r\n</tr>\r\n<tr>\r\n<td>Управление ФСБ России по Пермскому краю (телефон доверия)</td>\r\n<td>212-91-29</td>\r\n</tr>\r\n<tr>\r\n<td>Управление Федеральной службы РФ по контролю за оборотом наркотиков по Пермскому краю (телефон доверия)</td>\r\n<td>294-00-22</td>\r\n</tr>\r\n<tr>\r\n<td>Управление Федеральной миграционной службы России по Пермскому краю (телефон доверия)</td>\r\n<td>233-46-48</td>\r\n</tr>\r\n<tr>\r\n<td style="text-align: center; background-color: #dddddd;" colspan="2">Аварийные службы&nbsp;&nbsp;</td>\r\n</tr>\r\n<tr>\r\n<td>Центральная диспетчерская служба Пермской сетевой компании</td>\r\n<td>237-14-35; 237-15-06</td>\r\n</tr>\r\n<tr>\r\n<td>Контактно-информационная служба Новогор-Прикамье</td>\r\n<td>068; 210-06-00&nbsp;</td>\r\n</tr>\r\n<tr>\r\n<td>Диспетчерская служба наружного освещения Горсвет</td>\r\n<td>282-21-45&nbsp;</td>\r\n</tr>\r\n<tr>\r\n<td>Пермские городские электрические сети Орджоникидзевский РЭС</td>\r\n<td>284-88-89&nbsp;</td>\r\n</tr>\r\n<tr>\r\n<td>Центральная диспетчерская служба ЖКХ г. Перми</td>\r\n<td>&nbsp;057</td>\r\n</tr>\r\n<tr>\r\n<td style="text-align: center; background-color: #dddddd;" colspan="2">Справочные службы&nbsp;&nbsp;</td>\r\n</tr>\r\n<tr>\r\n<td>Call-центр главы г. Перми</td>\r\n<td>2-059-059</td>\r\n</tr>\r\n<tr>\r\n<td>Справочная телефонная служба&nbsp;</td>\r\n<td>09; 065 (платно)&nbsp;</td>\r\n</tr>\r\n</tbody>\r\n</table>', 'a:0:{}', NULL, NULL),
(5, NULL, 1, '2012-12-20', 'Контакты', 'contacts', '/contacts/', '', '<p><strong>Адрес:</strong> <span class="black">614030, г. Пермь, ул. Кабельщиков, 6<br /></span>(новый 10-этажный дом из красного и желтого кирпича, находящийся на перекрестке ул. Кабельщиков и ул. М.Толбухина, рядом со школой № 80)</p>', 'a:0:{}', NULL, NULL),
(16, NULL, 1, '2013-12-20', 'Новости', 'news', '/news/', '', '', 'a:0:{}', NULL, NULL),
(17, 16, 1, '2013-12-20', 'Первый заголовок новости', 'pervyy-zagolovok-novosti', '/news/pervyy-zagolovok-novosti/', 'Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.', '<p>Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.</p>', 'a:0:{}', NULL, NULL),
(18, 16, 1, '2003-12-20', 'Второй заголовок новости', 'vtoroy-zagolovok-novosti', '/news/vtoroy-zagolovok-novosti/', 'Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.', '<p>Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.</p>', 'a:0:{}', NULL, NULL),
(19, 16, 1, '2003-12-20', 'Третий заголовок новости', 'tretiy-zagolovok-novosti', '/news/tretiy-zagolovok-novosti/', 'Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.', '<p>Короткое описание новости. Желательно, что бы короткое описание у всех новостей было примрено одинаковой длины.</p>', 'a:2:{s:12:"content_main";a:3:{s:3:"tpl";s:0:"";s:9:"cnt_limit";s:1:"0";s:10:"hide_title";s:1:"0";}s:12:"content_view";a:4:{s:4:"date";s:1:"0";s:5:"short";s:1:"0";s:4:"more";s:1:"0";s:9:"more_text";s:0:"";}}', NULL, NULL),
(20, 0, 1, '2014-12-03', 'Руководство пользователя', 'rukovodstvo-polzovatelya', '/rukovodstvo-polzovatelya/', '', '<p>11234</p>', 'a:0:{}', NULL, NULL);

-- 
-- Вывод данных для таблицы component_param
--
-- Таблица simplex.component_param не содержит данных

-- 
-- Вывод данных для таблицы callback
--
-- Таблица simplex.callback не содержит данных

-- 
-- Вывод данных для таблицы admin_widget
--
-- Таблица simplex.admin_widget не содержит данных

-- 
-- Вывод данных для таблицы admin_menu
--
INSERT INTO admin_menu VALUES
(1, NULL, 2, 1, 'Администрирование', '/admin/admin/', '', 'home', 0),
(2, 1, 1, 1, 'Меню', '/admin/admin/menu/', 'admin_menu', 'share', 0),
(3, 1, 2, 3, 'Роли', '/admin/admin/role/', 'user_role', 'users', 0),
(4, 1, 1, 6, 'Привилегии', '/admin/admin/priv/', 'user_priv', 'users', 0),
(5, 1, 2, 2, 'Пользователи', '/admin/admin/user/', 'user', 'user', 0),
(6, 1, 2, 7, 'Права доступа', '/admin/admin/rights/', 'user_role_priv', 'users', 0),
(7, NULL, 2, 2, 'Сайт', '/admin/site/', '', 'briefcase', 0),
(9, 7, 2, 1, 'Меню', '/admin/site/menu/', 'menu', 'share', 0),
(10, 7, 2, 2, 'Модули', '/admin/site/module/', 'module_item', 'grid ', 0),
(11, 1, 1, 3, 'Компоненты', '/admin/admin/component/', 'component', 'layers', 0),
(12, NULL, 2, 3, 'Материалы', '/admin/content/', 'content', 'docs', 0),
(14, 7, 2, 8, 'Настройки', '/admin/site/settings/', 'settings', 'settings', 0),
(15, 7, 2, 9, 'SEO', '/admin/site/seo/', 'seo', 'bar-chart', 0),
(22, 1, 1, 10, 'Структура', '/admin/admin/structure/', 'struct_data', 'puzzle', 0),
...
(28, 1, 1, 5, 'Модули', '/admin/admin/module/', 'module', 'grid', 0),
(29, 1, 1, 5, 'Параметры модулей', '/admin/admin/module/param/', 'module_param', 'grid', 0),
(30, 1, 1, 4, 'Параметры компонентов', '/admin/admin/component_param/', 'component_param', 'layers', 0),
(31, NULL, 3, 57, 'Аккаунт', '/admin/account/', '', 'user', 1),
(32, NULL, 2, 6, 'Обратный звонок', '/admin/callback/', 'callback', 'call-in', 0),
(33, NULL, 2, 4, 'Слайдер', '/admin/slider/', 'slider', 'social-youtube', 0),
(34, 1, 1, 58, 'Установка дополнений', '/admin/install/', '', 'disc', 0),
(35, 1, 1, 54, 'Cron', '/admin/cron/', 'cron', 'speedometer', 0);
